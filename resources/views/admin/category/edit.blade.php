...
@section('page_title','Admin | Edit New Category')
@section('MainContent')
    <!-- Begin Page Content -->
               ...
               <div class="card-body">
                   <form action="/admin/category/update/{{ $category->id }}" method="POST" enctype="multipart/form-data">
                       ...
                       <div class="mt-3">
                           ...
                           <input type="text" value="{{ $category->category_name }}" class="form-control" name="category_name" placeholder="Enter Category Name">
                           @error('category_name')
                       ...
                       <div class="input-group mt-3">
                        ...
                        <img src="{{ asset('uploads/categories/'.$category->category_image) }}" height="100" width="150" id="pic" alt="">
