                        ...
                        <div class="row">
                                ...
                                <div class="mt-3">
                                    <label for="">Product Sub Category</label>
                                        <select name="product_subcategory" class="form-control" id="productSubCategory">
                                            ...
                                            <option {{ ($subcat->id == $product->sub_category) ? 'selected': '' }} value="{{ $subcat->id }}">{{ $subcat->sub_category_name }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                <div class="mt-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Discount" name="discount" value="{{ ($product->discount) ? $product->discount : '' }}" >
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                <div class="mt-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Product Actual Price" name="price" value="{{ $product->regular_price }}" >
                                    @error('price')
                                        <p style="color:red">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-10">
                                <div class="mt-3">
                                    ...
                                    <input type="text" placeholder="Enter Product name or title" name="product_title" class="form-control" value="{{ $product->product_title }}" >
                                    @error('product_title')
                                        <p style="color:red">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-4 col-md-8 col-sm-2">
                                <div class="mt-3">
                                    ...
                                    <input type="text" name="quantity" placeholder="Qauntity or in stock" class="form-control" value="{{ $product->quantity }}">
                                    @error('quantity')
                                        <p style="color:red">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mt-3">
                                    ...
                                    <textarea name="description"  class="form-control ckeditor" id="" cols="30" rows="10" placeholder="Write Product Description">{{ $product->description }}</textarea>
                                    @error('description')
                                        <p style="color:red">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mt-3">
                                    ...
                                    <textarea name="additional_info" class="form-control ckeditor"  id="" cols="30" rows="10" placeholder="Write Product Additional Information">{{ $product->addition_information }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-8">
                                <div class="mt-3">
                                    ...
                                    <textarea name="shipping_and_return_condition" class="form-control ckeditor"  id="" cols="30" rows="5">{{ $product->shipping_and_return_condition }}</textarea>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                ...
                                <img src="{{ asset('uploads/products/previews/'.$product->product_preview_img) }}" height="200" width="100%" id="pic" alt="">
