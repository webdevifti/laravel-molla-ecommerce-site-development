            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse {{ (request()->is('admin/categories') || request()->is('admin/category/create') || request()->is('admin/category/trash-list')) ? 'show' : '' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item {{ (request()->is('admin/category/trash-list')) ? 'active': '' }}" href="{{ route('admin.category.trashlist') }}">View Trash List @if($trashedItemCounnt) <span class="badge badge-info">{{ $trashedItemCounnt }}</span>@endif</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
