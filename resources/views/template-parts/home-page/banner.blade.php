    ...
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-4">
            <div class="banner banner-overlay banner-overlay-light">
                <a href="/shop">
                    <img src="{{ asset('site_assets/assets/images/demos/demo-4/banners/banner-1.png') }} " alt="Banner">
                </a>
                ...
                <div class="banner-content">
                    ...
                    <a href="/shop" class="banner-link">Shop Now<i class="icon-long-arrow-right"></i></a>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="banner banner-overlay banner-overlay-light">
                <a href="/shop">
                    <img src="{{ asset('site_assets/assets/images/demos/demo-4/banners/banner-2.jpg') }}" alt="Banner">
                </a>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="banner banner-overlay banner-overlay-light">
                <a href="/shop">
                    <img src="{{ asset('site_assets/assets/images/demos/demo-4/banners/banner-3.png') }} " alt="Banner">
                </a>
